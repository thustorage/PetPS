...
// static size_t cceh_mem_alloc = 0;
std::atomic<uint64_t> cceh_mem_alloc(0);

#define cceh_mem_record(size)  { /*cceh_mem_alloc += size / 64; if(size % 64 != 0) cceh_mem_alloc += 64;*/ }
